...
// AlertsClient is the client for the Alerts methods of the
...
//
// parameters is the clear alert request. resourceGroupName is the resource
...
//
// deviceName is the device name parameters is the send test alert email
// request. resourceGroupName is the resource group name managerName is the
// manager name
