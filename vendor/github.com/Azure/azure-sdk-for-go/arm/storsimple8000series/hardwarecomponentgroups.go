...
// methods of the Storsimple8000series service.
...
//
// deviceName is the device name hardwareComponentGroupName is the hardware
// component group name. parameters is the controller power state change
