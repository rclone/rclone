...
// BandwidthSettingsClient is the client for the BandwidthSettings methods of
// the Storsimple8000series service.
type BandwidthSettingsClient struct {
	ManagementClient
}

// NewBandwidthSettingsClient creates an instance of the
// BandwidthSettingsClient client.
...
// NewBandwidthSettingsClientWithBaseURI creates an instance of the
// BandwidthSettingsClient client.
...
// CreateOrUpdate creates or updates the bandwidth setting This method may poll
// for completion. Polling can be canceled by passing the cancel channel
// argument. The channel will be used to cancel polling and any outstanding
// HTTP requests.
//
// bandwidthSettingName is the bandwidth setting name. parameters is the
// bandwidth setting to be added or updated. resourceGroupName is the resource
...
// Delete deletes the bandwidth setting This method may poll for completion.
// Polling can be canceled by passing the cancel channel argument. The channel
// will be used to cancel polling and any outstanding HTTP requests.
//
// bandwidthSettingName is the name of the bandwidth setting. resourceGroupName
...
//
// bandwidthSettingName is the name of bandwidth setting to be fetched.
