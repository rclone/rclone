...
// RestoresClient is the client for the Restores methods of the
...
// NewRestoresClientWithBaseURI creates an instance of the RestoresClient
// client.
...
// Trigger restores the specified backed up data. This is an asynchronous
...
// backed up item to be restored. recoveryPointID is recovery point ID which
// represents the backed up data to be restored. parameters is resource restore
// request
