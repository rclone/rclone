...
// ProtectedItemOperationResultsClient is the client for the
// ProtectedItemOperationResults methods of the Recoveryservicesbackup service.
type ProtectedItemOperationResultsClient struct {
	ManagementClient
}

// NewProtectedItemOperationResultsClient creates an instance of the
...
// NewProtectedItemOperationResultsClientWithBaseURI creates an instance of the
// ProtectedItemOperationResultsClient client.
...
// container name associated with the backup item. protectedItemName is backup
// item name whose details are to be fetched. operationID is operationID which
// represents the operation whose result needs to be fetched.
