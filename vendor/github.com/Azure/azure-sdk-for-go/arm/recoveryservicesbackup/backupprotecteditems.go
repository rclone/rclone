...
// BackupProtectedItemsClient is the client for the BackupProtectedItems
// methods of the Recoveryservicesbackup service.
type BackupProtectedItemsClient struct {
	ManagementClient
}

// NewBackupProtectedItemsClient creates an instance of the
// BackupProtectedItemsClient client.
...
// NewBackupProtectedItemsClientWithBaseURI creates an instance of the
// BackupProtectedItemsClient client.
...
// List provides a pageable list of all items that can be backed up within a
// subscription.
//
