...
// ItemLevelRecoveryConnectionsClient is the client for the
// ItemLevelRecoveryConnections methods of the Recoveryservicesbackup service.
type ItemLevelRecoveryConnectionsClient struct {
	ManagementClient
}

// NewItemLevelRecoveryConnectionsClient creates an instance of the
// ItemLevelRecoveryConnectionsClient client.
...
// NewItemLevelRecoveryConnectionsClientWithBaseURI creates an instance of the
// ItemLevelRecoveryConnectionsClient client.
...
// Provision provisions a script which invokes an iSCSI connection to the
// backup data. Executing this script opens a file explorer displaying all the
...
// fabricName is fabric name associated with the backed up items. containerName
// is container name associated with the backed up items. protectedItemName is
// backed up item name whose files/folders are to be restored. recoveryPointID
// is recovery point ID which represents backed up data. iSCSI connection will
// be provisioned for this backed up data. parameters is resource ILR request
...
// Revoke revokes an iSCSI connection which can be used to download a script.
