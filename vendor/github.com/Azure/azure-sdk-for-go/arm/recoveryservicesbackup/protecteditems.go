...
// CreateOrUpdate enables backup of an item or to modifies the backup policy
// information of an already backed up item. This is an asynchronous operation.
...
// fabricName is fabric name associated with the backup item. containerName is
// container name associated with the backup item. protectedItemName is item
// name to be backed up. parameters is resource backed up item
...
// Delete used to disable backup of an item within a container. This is an
// asynchronous operation. To know the status of the request, call the
// GetItemOperationResult API.
//
// vaultName is the name of the recovery services vault. resourceGroupName is
// the name of the resource group where the recovery services vault is present.
// fabricName is fabric name associated with the backed up item. containerName
// is container name associated with the backed up item. protectedItemName is
...
// Get provides the details of the backed up item. This is an asynchronous
...
// fabricName is fabric name associated with the backed up item. containerName
// is container name associated with the backed up item. protectedItemName is
// backed up item name whose details are to be fetched. filter is oData filter
// options.
