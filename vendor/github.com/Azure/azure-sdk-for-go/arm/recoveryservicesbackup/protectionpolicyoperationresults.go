...
// ProtectionPolicyOperationResultsClient is the client for the
// ProtectionPolicyOperationResults methods of the Recoveryservicesbackup
// service.
type ProtectionPolicyOperationResultsClient struct {
	ManagementClient
}

// NewProtectionPolicyOperationResultsClient creates an instance of the
...
// NewProtectionPolicyOperationResultsClientWithBaseURI creates an instance of
// the ProtectionPolicyOperationResultsClient client.
...
// policyName is backup policy name whose operation's result needs to be
// fetched. operationID is operation ID which represents the operation whose
