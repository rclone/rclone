...
// Get provides the information of the backed up data identified using
...
// fabricName is fabric name associated with backed up item. containerName is
// container name associated with backed up item. protectedItemName is backed
// up item name whose backup data needs to be fetched. recoveryPointID is
...
// backed up item whose backup copies are to be fetched. filter is oData filter
// options.
