...
// BackupOperationStatusesClient is the client for the BackupOperationStatuses
// methods of the Recoveryservicesbackup service.
type BackupOperationStatusesClient struct {
	ManagementClient
}

// NewBackupOperationStatusesClient creates an instance of the
// BackupOperationStatusesClient client.
...
// NewBackupOperationStatusesClientWithBaseURI creates an instance of the
// BackupOperationStatusesClient client.
...
// Get fetches the status of an operation such as triggering a backup, restore.
...
// operationID is operationID which represents the operation.
