...
// SecurityPINsClient is the client for the SecurityPINs methods of the
...
// NewSecurityPINsClientWithBaseURI creates an instance of the
// SecurityPINsClient client.
