...
// JobOperationResultsClient is the client for the JobOperationResults methods
// of the Recoveryservicesbackup service.
type JobOperationResultsClient struct {
	ManagementClient
}

// NewJobOperationResultsClient creates an instance of the
// JobOperationResultsClient client.
...
// NewJobOperationResultsClientWithBaseURI creates an instance of the
// JobOperationResultsClient client.
...
// jobName is job name whose operation result has to be fetched. operationID is
