...
// NewCustomImagesClientWithBaseURI creates an instance of the
// CustomImagesClient client.
...
// CreateOrUpdate create or replace an existing custom image. This operation
...
// the lab. name is the name of the custom image. customImage is a custom
// image.
...
//
// resourceGroupName is the name of the resource group. labName is the name of
// the lab. name is the name of the custom image. expand is specify the $expand
// query. Example: 'properties($select=vm)'
...
// 'properties($select=vm)' filter is the filter to apply to the operation. top
// is the maximum number of resources to return from the operation. orderby is
