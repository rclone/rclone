...
// ListQuotas retrieves the subscription's current quota information in a
// particular region.
//
// location is the region in which to retrieve the subscription's quota
// information. You can find out which regions Azure Stream Analytics is
