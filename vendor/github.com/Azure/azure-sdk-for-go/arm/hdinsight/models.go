...
// ClusterProvisioningState enumerates the values for cluster provisioning
// state.
type ClusterProvisioningState string

const (
	// ClusterProvisioningStateCanceled specifies the cluster provisioning
	// state canceled state for cluster provisioning state.
	ClusterProvisioningStateCanceled ClusterProvisioningState = "Canceled"
	// ClusterProvisioningStateDeleting specifies the cluster provisioning
	// state deleting state for cluster provisioning state.
	ClusterProvisioningStateDeleting ClusterProvisioningState = "Deleting"
	// ClusterProvisioningStateFailed specifies the cluster provisioning state
	// failed state for cluster provisioning state.
	ClusterProvisioningStateFailed ClusterProvisioningState = "Failed"
	// ClusterProvisioningStateInProgress specifies the cluster provisioning
	// state in progress state for cluster provisioning state.
	ClusterProvisioningStateInProgress ClusterProvisioningState = "InProgress"
	// ClusterProvisioningStateSucceeded specifies the cluster provisioning
	// state succeeded state for cluster provisioning state.
...
// ClusterListPersistedScriptActionsResult is list PersistedScriptActions
// operations response.
...
// ClusterListRuntimeScriptActionDetailResult is the ListScriptExecutionHistory
// response.
...
// ExecuteScriptActionParameters is describes the script actions on a running
// cluster.
...
// HTTPConnectivitySettings is the payload for a Configure HTTP settings
// request.
...
// RDPSettingsParameters is parameters specifying the data factory gateway
// definition for a create or update operation.
...
// RuntimeScriptActionDetail is describes the execution details of a script
// action.
...
// ScriptActionExecutionSummary is describes the execution summary of a script
// action.
...
// ScriptActionPersistedGetResponseSpec is the persisted script action for
// cluster
...
// SecurityProfile is the security profile which contains Ssh public key for
