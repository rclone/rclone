...
// ConfigurationsClient is the the HDInsight Management Client.
type ConfigurationsClient struct {
	ManagementClient
}

// NewConfigurationsClient creates an instance of the ConfigurationsClient
// client.
func NewConfigurationsClient(subscriptionID string) ConfigurationsClient {
	return NewConfigurationsClientWithBaseURI(DefaultBaseURI, subscriptionID)
}

// NewConfigurationsClientWithBaseURI creates an instance of the
...
// of the cluster. configurationName is the constant for configuration type of
// gateway.
...
// UpdateHTTPSettings begins configuring the HTTP settings on the specified
// cluster. This method may poll for completion. Polling can be canceled by
// passing the cancel channel argument. The channel will be used to cancel
// polling and any outstanding HTTP requests.
//
// resourceGroupName is the name of the resource group. clusterName is the name
// of the cluster. configurationName is the constant for configuration type of
// gateway. parameters is the name of the resource group.
