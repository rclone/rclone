...
func (client IPPoolsClient) Create(ctx context.Context, location string, IPPool string, pool IPPool) (result IPPoolsCreateFuture, err error) {
	req, err := client.CreatePreparer(ctx, location, IPPool, pool)
	if err != nil {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "fabric.IPPoolsClient", "Create", result.Response(), "Failure sending request")
		return
	}
...
func (client IPPoolsClient) Get(ctx context.Context, location string, IPPool string) (result IPPool, err error) {
	req, err := client.GetPreparer(ctx, location, IPPool)
	if err != nil {
...
func (client IPPoolsClient) List(ctx context.Context, location string, filter string) (result IPPoolListPage, err error) {
	...
	result.ipl, err = client.ListResponder(resp)
	if err != nil {
...
func (client IPPoolsClient) listNextResults(lastResults IPPoolList) (result IPPoolList, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "fabric.IPPoolsClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "fabric.IPPoolsClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "fabric.IPPoolsClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
