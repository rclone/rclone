...
// databaseRid is cosmos DB database rid. collectionRid is cosmos DB collection rid. partitionKeyRangeID is
// partition Key Range Id for which to get data. filter is an OData filter expression that describes a subset of
