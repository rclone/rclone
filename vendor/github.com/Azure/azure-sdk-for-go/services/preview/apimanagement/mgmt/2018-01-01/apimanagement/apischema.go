...
// revision has ;rev=n as a suffix where n is the revision number. schemaID is schema identifier within an API.
// Must be unique in the current API Management service instance. parameters is the schema contents to apply.
...
// apiid is API revision identifier. Must be unique in the current API Management service instance. Non-current
// revision has ;rev=n as a suffix where n is the revision number. schemaID is schema identifier within an API.
// Must be unique in the current API Management service instance. ifMatch is eTag of the Entity. ETag should match
