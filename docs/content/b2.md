...
`N.B The default behaviour of uploading a file creates a version can be
 changed as evidenced in the screenshot below.
`

![Backblaze B2 life cycle settings for a bucket](images/B2-Cloud-Storage-Buckets.png "Backblaze B2 life cycle settings for a bucket")
