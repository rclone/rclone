...
SFTP supports reading the following system metadata for each object,
...
| gid | Group ID of owner | decimal number | 500 | **Y** |
| mode | File type and mode | octal, unix style | 0100664 | **Y** |
| mtime | Time of last modification | RFC 3339 | 2006-01-02T15:04:05.999999999Z07:00 | **Y** |
| uid | User ID of owner | decimal number | 500 | **Y** |
