...
#### --fichier-shared-password

If you want to download a password protected file from a shared folder, add this parameter

- Config:      shared_password
- Env Var:     RCLONE_FICHIER_SHARED_PASSWORD
- Type:        string
- Default:     ""
