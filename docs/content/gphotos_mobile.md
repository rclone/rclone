...
Here are the Standard options specific to gphotos_mobile (Google Photos Mobile API).

### --gphotos-mobile-auth-data
...
- Config:      auth_data
- Env Var:     RCLONE_GPHOTOS_MOBILE_AUTH_DATA
- Type:        string
- Required:    true

## Advanced options

Here are the Advanced options specific to gphotos_mobile (Google Photos Mobile API).

### --gphotos-mobile-proxy
...
- Config:      proxy
- Env Var:     RCLONE_GPHOTOS_MOBILE_PROXY
- Type:        string
- Required:    false

### --gphotos-mobile-cache-db-path
...
- Env Var:     RCLONE_GPHOTOS_MOBILE_CACHE_DB_PATH
- Type:        string
- Required:    false
