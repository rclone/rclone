...
```
      ...
      --rc-metrics                                 Enable the prometheus metrics endpoint
      ...
      --rc-metrics-htpasswd string                 A htpasswd file - if not provided no authentication is done
      --rc-metrics-key string                      TLS PEM Private key
      --rc-metrics-max-header-bytes int            Maximum size of request header (default 4096)
      --rc-metrics-min-tls-version string          Minimum TLS version that is acceptable (default "tls1.0")
      --rc-metrics-pass string                     Password for authentication
      --rc-metrics-realm string                    Realm for authentication
      --rc-metrics-salt string                     Password hashing salt (default "dlPL2MqE")
      --rc-metrics-server-read-timeout Duration    Timeout for server reading data (default 1h0m0s)
      --rc-metrics-server-write-timeout Duration   Timeout for server writing data (default 1h0m0s)
      --rc-metrics-template string                 User-specified template
      --rc-metrics-user string                     User name for authentication
