...
Lock files in Google Drive
    ...
    rclone backend lock remote: [options] [<arguments>+]

This command locks files in Google Drive to prevent modification.
...
Unlock files in Google Drive

    rclone backend unlock remote: [options] [<arguments>+]

This command unlocks files in Google Drive to allow modification.
