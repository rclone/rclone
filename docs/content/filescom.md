...
[Files.com](https://www.files.com/) is a cloud storage service that provides a secure and easy way to store and share files.

Paths are specified as `remote:path`

Paths may be as deep as required, e.g. `remote:directory/subdirectory`.

The initial setup for files involves getting an API Key from [Files.com](https://www.files.com/docs/sdk-and-apis/api-keys/).
