...
\[[This help in MD format](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/docs.md)\]  - \[[Download Rclone v1.63.1](https://github.com/rclone/rclone/releases/tag/v1.63.1)\]
...
After [download](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/downloads.md) and [install](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/install.md), continue
...
See the following for detailed instructions for
  ...
  * [1Fichier](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/fichier.md)
  * [Akamai Netstorage](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/netstorage.md)
  * [Alias](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/alias.md)
  * [Amazon Drive](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/amazonclouddrive.md)
  * [Amazon S3](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/s3.md)
  * [Backblaze B2](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/b2.md)
  * [Box](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/box.md)
  * [Chunker](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/chunker.md) - transparently splits large files for other remotes
  * [Citrix ShareFile](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/sharefile.md)
  * [Compress](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/compress.md)
  * [Combine](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/combine.md)
  * [Crypt](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/crypt.md) - to encrypt other remotes
  * [DigitalOcean Spaces](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/s3.md#digitalocean-spaces)
  * [Digi Storage](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/koofr.md#digi-storage)
  * [Dropbox](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/dropbox.md)
  * [Enterprise File Fabric](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/filefabric.md)
  * [FTP](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/ftp.md)
  * [Google Cloud Storage](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/googlecloudstorage.md)
  * [Google Drive](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/drive.md)
  * [Google Photos](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/googlephotos.md)
  * [Hasher](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/hasher.md) - to handle checksums for other remotes
  * [HDFS](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/hdfs.md)
  * [HiDrive](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/hidrive.md)
  * [HTTP](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/http.md)
  * [Internet Archive](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/internetarchive.md)
  * [Jottacloud](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/jottacloud.md)
  * [Koofr](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/koofr.md)
  * [Mail.ru Cloud](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/mailru.md)
  * [Mega](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/mega.md)
  * [Memory](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/memory.md)
  * [Microsoft Azure Blob Storage](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/azureblob.md)
  * [Microsoft OneDrive](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/onedrive.md)
  * [OpenStack Swift / Rackspace Cloudfiles / Blomp Cloud Storage / Memset Memstore](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/swift.md)
  * [OpenDrive](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/opendrive.md)
  * [Oracle Object Storage](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/oracleobjectstorage.md)
  * [Pcloud](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/pcloud.md)
  * [PikPak](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/pikpak.md)
  * [premiumize.me](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/premiumizeme.md)
  * [put.io](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/putio.md)
  * [QingStor](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/qingstor.md)
  * [Seafile](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/seafile.md)
  * [SFTP](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/sftp.md)
  * [Sia](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/sia.md)
  * [SMB](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/smb.md)
  * [Storj](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/storj.md)
  * [SugarSync](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/sugarsync.md)
  * [Union](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/union.md)
  * [Uptobox](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/uptobox.md)
  * [WebDAV](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/webdav.md)
  * [Yandex Disk](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/yandex.md)
  * [Zoho WorkDrive](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/zoho.md)
  * [The local filesystem](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/local.md)
...
* [rclone config](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_config.md)	- Enter an interactive configuration session.
* [rclone copy](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_copy.md)		- Copy files from source to dest, skipping already copied.
* [rclone sync](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_sync.md)		- Make source and dest identical, modifying destination only.
* [rclone bisync](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_bisync.md)	- [Bidirectional synchronization](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/bisync.md) between two paths.
* [rclone move](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_move.md)		- Move files from source to dest.
* [rclone delete](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_delete.md)	- Remove the contents of path.
* [rclone purge](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_purge.md)	- Remove the path and all of its contents.
* [rclone mkdir](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_mkdir.md)	- Make the path if it doesn't already exist.
* [rclone rmdir](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_rmdir.md)	- Remove the path.
* [rclone rmdirs](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_rmdirs.md)	- Remove any empty directories under the path.
* [rclone check](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_check.md)	- Check if the files in the source and destination match.
* [rclone ls](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_ls.md)		- List all the objects in the path with size and path.
* [rclone lsd](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_lsd.md)		- List all directories/containers/buckets in the path.
* [rclone lsl](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_lsl.md)		- List all the objects in the path with size, modification time and path.
* [rclone md5sum](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_md5sum.md)	- Produce an md5sum file for all the objects in the path.
* [rclone sha1sum](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_sha1sum.md)	- Produce a sha1sum file for all the objects in the path.
* [rclone size](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_size.md)		- Return the total size and number of objects in remote:path.
* [rclone version](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_version.md)	- Show the version number.
* [rclone cleanup](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_cleanup.md)	- Clean up the remote if possible.
* [rclone dedupe](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_dedupe.md)	- Interactively find duplicate files and delete/rename them.
* [rclone authorize](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_authorize.md)	- Remote authorization.
* [rclone cat](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_cat.md)		- Concatenate any files and send them to stdout.
* [rclone copyto](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_copyto.md)	- Copy files from source to dest, skipping already copied.
* [rclone genautocomplete](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_genautocomplete.md)	- Output shell completion scripts for rclone.
* [rclone gendocs](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_gendocs.md)	- Output markdown docs for rclone to the directory supplied.
* [rclone listremotes](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_listremotes.md)	- List all the remotes in the config file.
* [rclone mount](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_mount.md)	- Mount the remote as a mountpoint.
* [rclone moveto](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_moveto.md)	- Move file or directory from source to dest.
* [rclone obscure](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_obscure.md)	- Obscure password for use in the rclone.conf
* [rclone cryptcheck](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_cryptcheck.md)	- Check the integrity of an encrypted remote.
* [rclone about](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_about.md)	- Get quota information from the remote.

See the [commands index](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands.md) for the full list.
...
overview](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/overview.md#optional-features)) support server-side copy.
...
in their docs and are listed in the [features table](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/overview.md#features)
(Eg [local](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/local.md#metadata), [s3](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/s3.md#metadata))
...
See the [mount](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_mount.md#file-buffering) documentation for more details.
...
You can use the [config paths](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_config_paths.md)
command to see the current value.

Cache directory is heavily used by the [VFS File Caching](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_mount.md#vfs-file-caching)
mount feature, but also by [serve](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_serve.md), [GUI](/gui) and other parts of rclone.
...
section](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/overview.md).
...
A special, and required, key `type` identifies the [storage system](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/overview.md),
...
Note that passwords are in [obscured](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_obscure.md)
...
See the overview [features](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/overview.md#features) and
[optional features](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/overview.md#optional-features) to get an idea of
...
The various [list](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_ls.md) commands output raw numbers by default.
Option `--human-readable` will make them output values in human-readable format
instead (with the short unit prefix).

The [about](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_about.md) command outputs human-readable by default,
with a command-specific option `--full` to output the raw numbers instead.

Command [size](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_size.md) outputs both human-readable and raw numbers
in the same output.

The [tree](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_tree.md) command also considers `--human-readable`, but
...
The interactive command [ncdu](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_ncdu.md) shows human-readable by
...
See [rclone copy](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/commands/rclone_copy.md) for an example of how to use it.
...
See the [filtering section](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/filtering.md).
...
See [the remote control section](https://github.com/rclone/rclone/blob/v1.63.1/docs/content/rc.md).
