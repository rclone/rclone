...
<i class="fa fa-space-shuttle"></i>Mail.ru Cloud
----------------------------------------
...
- Maximum file size is limited by 2G for a free acount, unlimited for paid tariffs
...
User agent used by client (internal)

- Config:      user_agent
- Env Var:     RCLONE_MAILRU_USER_AGENT
- Type:        string
- Default:     "CloudDiskOWindows 17.12.0009 beta WzBbt1Ygbm"

#### --mailru-quirks

Comma separated list of internal maintenance flags. This option is intended
for development purposes and must not be used by an ordinary user.
