...
Supply a Dropbox Oauth Access Token as a JSON blob.

This option can be used in conjuction with --dropbox-client-id
and --dropbox-client-secret to keep all plaintext credentials
off-disk.
