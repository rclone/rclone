...
### vfs/transfers: Get active VFS transfers and cache status. {#vfs-transfers}

This returns information about active file transfers and cache state
for the VFS. It shows files that are currently open or downloading,
along with their cache status and read position tracking.
    ...
    "transfers": [
        {
            ...
            "readBytes": 268435456,
            "readOffset": 268435456,
            "readOffsetPercentage": 25,
            "readSpeed": 10485760
        }
    ],
    "summary": {
...
- Cache state: **cacheStatus** (none/partial/full/unknown), **cacheBytes**, **cachePercentage**
- Download state: **downloading**, **downloadBytes**, **downloadSpeed**, **downloadSpeedAvg**
- Read tracking: **readBytes** (total read), **readOffset** (last read position), **readOffsetPercentage**, **readSpeed** (bytes/sec with EMA decay)
- File info: **name**, **size**, **opens**, **dirty**, **lastAccess**

The **readSpeed** uses an exponential moving average that decays to 0
after 2 seconds of inactivity, providing accurate real-time read speed
for media streaming monitoring.
