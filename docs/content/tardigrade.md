...
Use the `copy` command to upload an object.
    ...
    rclone copy /home/local/directory/file.ext remote:bucket/path/to/dir/

Use a folder in the local path to upload all its objects.

    rclone copy /home/local/directory/ remote:bucket/path/to/dir/
...
Use the `copy` command to download an object.
    ...
    rclone copy remote:bucket/path/to/dir/file.ext /home/local/directory/

Use a folder in the remote path to download all its objects.

    rclone copy remote:bucket/path/to/dir/ /home/local/directory/
...
changing the destination only, deleting any excess files.
    ...
    rclone sync -i /home/local/directory/ remote:bucket/path/to/dir/
...
The sync can be done also from Tardigrade to the local file system.
    ...
    rclone sync -i remote:bucket/path/to/dir/ /home/local/directory/

Or between two Tardigrade buckets.

    rclone sync -i remote-us:bucket/path/to/dir/ remote-europe:bucket/path/to/dir/

Or even between another cloud storage and Tardigrade.

    rclone sync -i s3:bucket/path/to/dir/ tardigrade:bucket/path/to/dir/
