...
log_info "setup" "  export RCLONE_CONFIG=${CONFIG_FILE}"
log_info "setup" "  go test ./fs/operations -remote localraid3: -v"
log_info "setup" "  go test ./fs/sync -remote localraid3: -v"
