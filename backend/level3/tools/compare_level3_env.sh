#!/usr/bin/env bash
#
# compare_level3_env.sh
# ----------------------
# Default environment for level3 bash-based comparison/recovery/heal scripts.
# You can copy this file to compare_level3_env.local.sh and adjust values to
...
# MinIO-backed level3 backend directories
