...
- `backend/level3/level3.go` - `Update()`, `updateWithRollback()`, `rollbackUpdate()` functions
- `backend/level3/tools/MOVE_ROLLBACK_IMPLEMENTATION.md` - Move rollback implementation (similar pattern)
- `backend/level3/tools/MOVE_FAILURE_ANALYSIS.md` - Move failure analysis (similar issues)
- `backend/level3/README.md` - Documents rollback for "Put, Update, Move" (needs update)
...
2. **Create comprehensive tests**:
   - Add `update-fail` scenarios to `compare_level3_with_single_errors.sh`
...
**See also**: `backend/level3/OPEN_QUESTIONS.md` - Q1: Update Rollback Not Working Properly
...
**Files Fixed**:
- `backend/level3/level3.go` - Lines 547, 557, 567 (NewFs initial construction)
- `backend/level3/level3.go` - Lines 632, 641, 650 (adjusted root handling)
...
**Files Changed**:
- `backend/level3/tools/compare_level3_common.sh` - Line 528: Changed prefix in `create_test_dataset()`
- `backend/level3/tools/compare_level3_with_single.sh` - Line 919: Changed prefix in mkdir test
