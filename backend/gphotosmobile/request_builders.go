...
func buildGetLibStateRequest(stateToken string) []byte {
	...
	collMask1 := NewProtoBuilder()
	collMask1.AddEmptyMessage(2)
	collMask1.AddEmptyMessage(3)
	collMask1.AddEmptyMessage(4)
	collMask1.AddEmptyMessage(5)
	f6 := NewProtoBuilder()
	...
	collMask1.AddMessage(6, f6)
	collMask1.AddEmptyMessage(7)
	collMask1.AddEmptyMessage(8)
	collMask1.AddEmptyMessage(10)
	collMask1.AddEmptyMessage(12)
	cm13 := NewProtoBuilder()
	cm13.AddEmptyMessage(2)
	cm13.AddEmptyMessage(3)
	collMask1.AddMessage(13, cm13)
	cm15 := NewProtoBuilder()
	cm15.AddEmptyMessage(1)
	collMask1.AddMessage(15, cm15)
	collMask1.AddEmptyMessage(18)
	collMask.AddMessage(1, collMask1)
	cm4 := NewProtoBuilder()
