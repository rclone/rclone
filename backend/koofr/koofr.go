...
// The configuration of the Koofr backend
type Options struct {
...
// Size time of the object
func (o *Object) Size() int64 {
	return o.info.Size
}

// A reference to the Koofr fs containing the object
...
// Returns full path of the remote object (including fs root)
func (o *Object) fullPath() string {
	return o.fs.fullPath(o.remote)
}

// Is the object storable?
func (o *Object) Storable() bool {
	return true
}

// Setting modification time is not supported
...
// String representation of the fs
func (f *Fs) String() string {
	return "koofr:" + f.mountID + ":" + f.root
}

// Features supported by this fs
...
// MD5 hashes are provided by the fs
func (f *Fs) Hashes() hash.Set {
	return hash.Set(hash.MD5)
}

// Given a fs-root relative path, constructs a full, absolute path
func (f *Fs) fullPath(part string) string {
	return path.Join("/", f.root, part)
}

// Constructs a new filesystem given a root path and the configuration
...
// Creates a new remote object for a given remote path
...
// Updates a remote object with a stream of unknown size
...
// Translates koofr errors to rclone errors (for a dir operation)
...
// Translates koofr errors to rclone errors (for an object operation)
...
// Creates a directory at the given remote path. Creates parent if neccessary.
...
// Removes an (empty) directory at the given remote path.
...
// Copies a remote object to the given path
...
// Moves a remote object to the given path
...
// Moves a remote directory to the given path
...
// Reports usage (with a MB precision)
...
// Koofr API request for creating a public link
type linkCreate struct {
	Path string `json:"path"`
}

// Koofr API response to creating a public link
type link struct {
	ID               string `json:"id"`
...
// Koofr API call to create a public link
...
// Create a public link to the remote path
