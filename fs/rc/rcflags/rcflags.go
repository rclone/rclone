...
func AddFlags(flagSet *pflag.FlagSet) {
	...
	flags.BoolVarP(flagSet, &Opt.Share, "rc-share", "", false, "Enable share remote objects.")
	...
	flags.StringVarP(flagSet, &Opt.AccessControlAllowOriginShare, "rc-allow-origin-share", "", "", "Set the allowed origin for CORS in shared link.")
