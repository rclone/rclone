...
func AddFlags(ci *fs.ConfigInfo, flagSet *pflag.FlagSet) {
	...
	flags.BoolVarP(flagSet, &ci.NoProgress, "no-progress", "", ci.NoProgress, "Hide progress during transfer.")
	flags.BoolVarP(flagSet, &ci.StatsPerTransfer, "stats-per-transfer", "", ci.StatsPerTransfer, "Show stats per transfer.")
	flags.BoolVarP(flagSet, &ci.ProgressTerminalTitle, "progress-terminal-title", "", ci.ProgressTerminalTitle, "Show progress on the terminal title.")
