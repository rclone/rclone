...
func AddFlags(ci *fs.ConfigInfo, flagSet *pflag.FlagSet) {
	...
	flags.IntVarP(flagSet, &ci.ChunkConcurrency, "chunk-concurrency", "", ci.ChunkConcurrency, "Number of chunks to transfer in parallel")
	flags.FVarP(flagSet, &ci.ChunkSize, "chunk-size", "", "Size of the chunk to transfer")
	flags.FVarP(flagSet, &ci.ChunkCutoff, "chunk-cutoff", "", "Cutoff for using chunks")
