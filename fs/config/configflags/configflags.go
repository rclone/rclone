...
func AddFlags(ci *fs.ConfigInfo, flagSet *pflag.FlagSet) {
	...
	flags.FVarP(flagSet, &ci.BwLimit, "bwlimit", "", "Bandwidth limit in KiB/s, or use suffix B|Ki|Mi|Gi|Ti|Pi or a full timetable")
	flags.FVarP(flagSet, &ci.BwLimitFile, "bwlimit-file", "", "Bandwidth limit per file in KiB/s, or use suffix B|Ki|Mi|Gi|Ti|Pi or a full timetable")
