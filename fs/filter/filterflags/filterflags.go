...
func AddFlags(flagSet *pflag.FlagSet) {
	...
	flags.FVarP(flagSet, &Opt.MinSize, "min-size", "", "Only transfer files bigger than this in KiB or suffix B|Ki|Mi|Gi|Ti|Pi")
	flags.FVarP(flagSet, &Opt.MaxSize, "max-size", "", "Only transfer files smaller than this in KiB or suffix B|Ki|Mi|Gi|Ti|Pi")
