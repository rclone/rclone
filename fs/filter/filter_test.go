...
func TestParseHashFilter(t *testing.T) {
	for _, test := range []struct {
		...
		{hashFilter: "-1/2", err: "can't parse numerator"},
		{hashFilter: "1/-2", err: "can't parse denominator"},
		{hashFilter: "1/100000000000000000000", err: "can't parse denominator"},
		{hashFilter: "100000000000000000000/1", err: "can't parse numerator"},
