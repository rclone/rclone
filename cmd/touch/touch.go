...
//
// The returned fs will never point to a file. It will
// point to the parent directory of specified path,
// is returned together with the name of file or directory,
// except if argument is only a remote name.
// Similar to cmd.NewFsDstFile, but without raising fatal
// when name of file or directory is empty.
